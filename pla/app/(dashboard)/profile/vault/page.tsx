    ...
    <main className="min-h-screen bg-[#0d1b2a] px-4 py-8 text-slate-100">
      <div className="mx-auto max-w-md">
        ...
        <section className="mt-8 rounded-xl border border-[#1e3248] bg-[#111d2e] p-5">
          ...
          <h1 className="text-lg font-bold">Coffre-fort sécurisé</h1>
          <p className="mt-2 text-sm leading-relaxed text-slate-400">
            Les données sensibles sont chiffrées localement sur cet appareil. La synchronisation cloud pourra être activée depuis les paramètres.
          </p>
        </section>
      </div>
    </main>
